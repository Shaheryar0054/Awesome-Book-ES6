...
**[Awesome-Book-with-ES6]** In this project we build simple application that have ability to add and remove books
...
```
    https://github.com/Shaheryar0054/Awesome-Book-ES6 
```
...
- [Used ES6 syntax] **[new_feature_1]**
- [Used Arrow function] **[new_feature_2]**
...
Feel free to check the [issues page](https://github.com/Shaheryar0054/Awesome-Book-ES6/issues).
